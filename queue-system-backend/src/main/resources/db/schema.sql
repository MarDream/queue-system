...
-- =============================================
INSERT INTO `sys_user` (`username`, `password`, `name`, `role`, `region_id`, `region_code`, `status`) VALUES
('admin', '$2a$10$YvDcCi7FNwYahz2JkUwYqOcugV1mocqOUb2EZvWEsihhcercZ4bUG', '超级管理员', 'SUPER_ADMIN', NULL, NULL, 1);
